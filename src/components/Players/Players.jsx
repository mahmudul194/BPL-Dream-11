      ...
      <div className="flex justify-between gap-4 items-center mb-5">
        ...
        <div>
          <button
            ...
            className={`btn ${isSelected === "available" ? "bg-[#E7F929]" : "btn"} rounded-r-none rounded-l-xl`}
          >
            Available
          </button>
          <button
            onClick={() => setSelected("selected")}
            className={`btn rounded-l-none ${isSelected === "selected" ? "bg-[#E7F929]" : "btn"} rounded-r-xl`}
          >
